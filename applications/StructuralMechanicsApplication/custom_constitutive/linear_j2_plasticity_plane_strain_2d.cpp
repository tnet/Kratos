...
Vector& LinearJ2PlasticityPlaneStrain2D::CalculateValue(
    ...
    )
{
    ...
    //    ConstitutiveLawUtilities<4>::CalculateGreenLagrangianStrain(C_tensor, rValue);
    //}
